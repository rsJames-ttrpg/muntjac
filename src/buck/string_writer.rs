...
fn emit_wiring_bzl(input: &EmitInput) -> String {
    ...
    writeln!(s, "## Do not edit by hand.").unwrap();
    writeln!(s, "##").unwrap();
    writeln!(s, "## Host-axis modifiers for muntjac's per-cell platform constraints.").unwrap();
    writeln!(s, "##").unwrap();
    writeln!(
        s,
    ...
    writeln!(s, "##").unwrap();
    writeln!(s, "## Wiring contract for consumers — add to your root PACKAGE:").unwrap();
    writeln!(s, "##").unwrap();
    writeln!(
        s,
        "##   load("
